...
class Trips
{
  ...
  public:
    Trips();
    Trips(string routeid, string serviceid, string tripid, string tripheadsign, string tripshortname, string directionid, string blockid, string shapeid, string wheelchairaccessible, string bikesallowed);
    ~Trips();
...
Trips::Trips(string routeid, string serviceid, string tripid, string tripheadsign, string tripshortname, string directionid, string blockid, string shapeid, string wheelchairaccessible, string bikesallowed)
{
